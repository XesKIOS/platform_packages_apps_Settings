...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_XESKI_VERSION = "xeski_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_XESKI_VERSION, "ro.xeski.version");
        findPreference(KEY_XESKI_VERSION).setEnabled(true);
